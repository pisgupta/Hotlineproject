...
/**
 * This class is used to fetch the user's location via the Location api.
 * <p/>
 * This class also checks whether the location is being fetched from
 * the network provider or the gps provider.
 */
